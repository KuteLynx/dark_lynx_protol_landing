...
| Journal lazy paginated feed flow | `flows/journal-loading.md` |
...
| Warm-on-boot pattern (superseded) | `decisions/0004-warm-on-boot.md` |
...
| `modules/journal.md` | JournalStore (paginated), lazy feed, journal API, schema.sql, Render API |
...
| `flows/journal-loading.md` | Root healthPing → /diario mount → loadInitialEntries → IntersectionObserver → loadMore |
